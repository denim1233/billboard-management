...
import {
    contractModifyColumns,
    forModificationColumns,
...
const ForModification = () => {
    ...
    useEffect(() => {
        //dynamic columns
        let active = Helper.getItemCache("modificationColumn");
        if (active === null) {
            active = forModificationColumns;
        }
        let result = active.map((a) => a.id);
        let temp2 = hideColumn(forModificationColumns, result);
        setColumn(temp2);
    ...
    useEffect(() => {
        Helper.addItemCache("modificationColumn", tableColumn);
    }, [tableColumn]);
                ...
                <div className="card">
                    <div className="card-body">
                        <div className="container-fluid">
                            ...
                            <div className="card">
                                <CardHeader title="for modification" />
...
export default ForModification;
